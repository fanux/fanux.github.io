...
使用容器的前期投入到底有多大，这个不是很好估计，企业个体差异比较大，而且和使用到哪种程度也很有关系。然而有一点可以肯定的是：一个没有比较专业的容器相关人才的公司想要在两三个月内去把容器玩到线上是一件不太容易的事（业务非常简单的例外）
...
其实对于很多企业来说时间成本比资金成本更贵，时间的推延会导致各项成本的增加。关键是能把容器玩的很溜的人还比较难找.
